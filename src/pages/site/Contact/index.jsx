                            ...
                            <div className="contact1">
                              ...
                              <div className="form">
                                ...
                                <form onSubmit={submitContact} ref={FormRep} method="post" >
                                  ...
                                  <button className="button">Gửi Email</button>
                                </form>
                              </div>
                            </div>
                          </div>
