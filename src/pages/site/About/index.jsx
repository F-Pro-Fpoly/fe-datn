            ...
            <div className="container">
                <div className="row">
                    ...
                    <div className="col-lg-6">
                        ...
                        <p><b>Phòng Khám Đa Khoa </b> xin gửi đến Quý khách lời chúc sức khỏe, an lành và hạnh phúc.</p>
                ...
                <div className="row my-5">
                    <div className="col-sm-6 col-lg-4">
                        <div className="service-block-inner">
                            ...
                            <p>Song song với đầu tư trang thiết bị kỷ thuật cao thì phòng khám cũng nâng cao y đức, thái độ phục vụ người dân với phương châm “LƯƠNG Y NHƯ TỪ MẪU”, vì thế số lượng đăng ký tham gia khám chữa bệnh ban đầu tại Phòng Khám Đa khoa Sài Gòn hiện nay là 137.000/người( một trăm ba mươi bảy ngàn người). </p>
                        </div>
                    </div>
                    <div className="col-sm-6 col-lg-4">
                        <div className="service-block-inner">
                            <h3>ĐỘI NGŨ Y BÁC SĨ CÓ CHUYÊN MÔN CAO</h3>
                            <p>– Không giống như các  phòng khám khác, Phòng Khám Trung Tâm Y Tế Hà Đô hội tụ một đội ngũ bác sĩ ưu tú trong và ngoài nước, trên 20 năm kinh nghiệm, có bằng cấp được Bộ Y tế công nhận, nên mọi người có thể an tâm thăm khám. </p>
                            <p>– Tất cả các bác sĩ tại đây đều đã có thâm niên công tác lâu năm tại nhiều bệnh viện lớn trong cả nước trước khi về làm việc tại Hà Đô. Chính vì thế bệnh nhân có thể an tâm về chất lượng hỗ trợ khám chữa bệnh của chúng tôi không hề thua kém các đơn vị y tế công lập khác </p>
                    ...
                    <div className="col-sm-6 col-lg-4">
                        <div className="service-block-inner">
                            ...
                            <p>– Phòng khám Hà Đô có tốt không? là câu hỏi của rất nhiều người. Trong số tất cả các Phòng khám tư hiện nay tại TP.HCM, Phòng Khám Trung Tâm Y Tế Hà Đô có ưu thế hơn hẳn nhờ việc áp dụng rất nhiều kỹ thuật tiên tiến hiện nay để hỗ trợ điều trị các bệnh lý về sức khỏe sinh sản, thẩm mỹ bộ phận sinh dục, điển hình như: </p>
